...
@router.put(
    ...
    description=(
        ...
        "**Временную фиксацию закрывайте сроком** (`ends_on`, tsk-866): цена "
        "действует по указанный месяц включительно, дальше считается тариф. "
        "Пусто — бессрочно. Выпуск ученика проставляет срок сам — цена привязана "
        "к обучению и без него теряет основание."
    ),
)
