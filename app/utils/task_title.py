...
# tsk-341: подсказка при наведении на карточке ученика — тот же `title`, но не
# обрезанный под ширину строки. Ограничена (не 0/безлимит): stem программных
# задач бывает до сотен КБ, всплывающая подсказка на весь экран нечитаема.
HINT_MAX_LEN = 500
