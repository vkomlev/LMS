...
def start_scheduler() -> Optional[AsyncIOScheduler]:
    ...
    register_interval_job(
        ...
        job_id="tsk541_course_dependency_state_cron",
        startup_delay_min=settings.course_dependency_state_cron_startup_delay_min,
