...
async def course_dependency_state_cron_tick(
    ...
    async with factory() as db:
        ...
        for required_course_id, student_ids in needed.items():
        ...
        await db.commit()
        logger.info(
            "tsk-541 course_dependency_state_cron_tick done pairs=%s recomputed=%s",
            summary["pairs_checked"], summary["students_recomputed"],
        )
