...
MAGNETS: Dict[str, MagnetCopy] = {
    ...
    "wp:backend-gotovnost": MagnetCopy(
        # Программа «Backend-разработчик на Python» (курс 1746, tsk-768): Python,
        # HTTP и API, базы данных, git — всё, что проверяют зонды, — плюс FastAPI и
        # выкладка. До 24.09.2026 курса не было, и магнит вёл на «Создание чат-ботов».
        recommendation_course_uid="lms:tsk768:backend",
        contact_weak=(
