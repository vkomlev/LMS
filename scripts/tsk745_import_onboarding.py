...
IMAGES: Dict[str, tuple] = {
    "onb-oge-bally": (
        "Столбчатая диаграмма: двенадцать одинаковых невысоких столбиков по одному баллу "
        "за задания с первого по двенадцатое и четыре высоких столбика за практические "
        "задания 13-16 весом два, три, два и два балла",
        "Четыре практических задания дают почти столько же, сколько все двенадцать коротких.",
    ),
    "onb-ege-karta": (
    ...
    "onb-menu": (
        "Кабинет на телефоне: сверху кнопка с тремя полосками и надпись Платформа, ниже выехавшая панель Меню со списком разделов — Курсы, Занятия, Сообщения, Прогресс, История, Оплата, Тариф, Профиль",
        "Нажал полоски — открылся список разделов. На компьютере они видны сразу, без нажатия.",
    ),
    "onb-kurs-karta": (
    ...
    "onb-kurs-derevo": (
        "Страница курса на телефоне: название, счётчик задач и материалов, синяя кнопка "
        "«Открыть следующий материал», ниже вкладки Разделы, Лента, Программа и список "
        "разделов с галочкой у пройденного и знаком внимания у начатого",
        "Кнопка следующего шага — ответ на вопрос «что мне делать». Здесь дальше идёт "
        "теория, поэтому надпись про материал.",
    ),
    "onb-zadanie": (
