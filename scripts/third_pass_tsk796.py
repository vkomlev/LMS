...
PLAN: Dict[int, List[Tuple[str, str]]] = {
    ...
    10193: [("оплата", "NOUN")],
    # --- добор: эталоны смешанные (слово + словосочетание), поэтому задание
    # не прошло ни фильтр одиночных слов, ни фильтр словосочетаний ---
    7704: [("текст", "NOUN")],          # «числа записаны текстом»
    9034: [("сервер", "NOUN")],         # «на чьей стороне дефект»
}
