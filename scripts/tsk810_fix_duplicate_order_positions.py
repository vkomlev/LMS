"""tsk-810: развести дубликаты `tasks.order_position` в курсах 146 и 147.

Что за дефект. В обоих курсах на каждой занятой позиции стоят два задания
(в 147 на позиции 17 — три): одно активное и один-два архивных импортных
шаблона (`pdf:d4:pdf:crylov:*`, `tg:ege:*`, `ext:calib:*`). След массового
...
и 1..28 в курсе 147. Дубликаты видны лишь в общем списке методиста, где
архив соседствует с действующими заданиями.
