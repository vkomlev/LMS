...
- **Брендбук «Дипломата» разрешает знак без надписи только по согласованию**
  (блок 1, стр. 14). В шапке кабинета знак стоит рядом со словом «Дипломат» —
  это надо подтвердить у коллег отдельной строкой в переписке.
