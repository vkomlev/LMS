...
@pytest.mark.parametrize(
    "value, etalon",
    [
        ("2 102 556 498", "2102556498"),   # разряды пробелами (задание 119)
        ("123456789", "1 2 3 4 5 6 7 8 9"),  # обратный случай (задания 216, 230)
        ("небоскрёб", "небоскреб"),          # ё против е (задание 4920)
...
def test_подсказка_не_упоминает_регистр():
    ...
    general = _general(_check("небоскрёб", _rules(["небоскреб"], normalization=["trim"])))
