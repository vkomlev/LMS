...
### 6. Автоматическая привязка детей при привязке родителя к преподавателю
...
### 7. Автоматическая отвязка детей при отвязке родителя от преподавателя
...
### 8. Синхронизация при добавлении ребенка в иерархию
...
### 9. Синхронизация при удалении ребенка из иерархии
