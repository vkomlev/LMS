...
# Только настоящие HTML-теги: после '<' — буква или '/'. Иначе '$n<−100000$'
# (математическое «меньше») съедалось как тег до следующего '>' и вырезало
# кусок условия — ложно склеивало разные задания (задание 16, рекурренты).
