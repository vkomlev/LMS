...
Выкачено: LMS `9e811aa`, SPW `a9708df`. Кабинет маркетолога
`https://learn.victor-komlev.ru/marketer/charges`, сессия — id 2
(`admin`+`marketer`), кнопка «Сверить оплаты картой за август 2026».

На экране после сверки (проверено глазами по скриншоту):

```
Сверить оплаты картой за август 2026    У сервиса 3, из них учтено 2
Учесть нечем: 1 — разбирает человек
10 ₽ · 03.08.26, 15:30 · Комлев Виктор · Начисление №47 не найдено: его удалили после оплаты
32029d8b-000f-5001-9000-116bf07a398a
```

То есть ровно тот платёж, ради которого задача и заводилась: сумма, дата
(12:30 UTC = 15:30 по Москве), ученик и причина видны без похода в кабинет
ЮKassa. «Расхождений нет» экран больше не пишет. Дозакрыто 0 строк — боевые
данные прогоном не изменились.
