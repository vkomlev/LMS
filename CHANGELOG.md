...
## 2026-09-08 — Темп ученика больше не зависит от дня недели (tsk-819)

- «Делает N в неделю» считалось по календарным неделям, и окно заканчивалось прошлым воскресеньем: работа текущей недели не попадала в расчёт вовсе. Ненулевой темп получался ровно по понедельникам, у новичка — никогда: его единственное окно приходилось на неделю, в которую он ещё не занимался.
- Теперь окна скользящие, по семь дней от момента расчёта. Все окна полные — неполной текущей недели, занижающей медиану, не возникает.
- Что это меняет для преподавателя: у пятерых из 64 активных учеников в карточке стояло «делает 0» при 229 верных сдачах за неделю. Числа в сводке и на дашборде вырастут — это и есть исправление, а не сбой. От темпа зависят выдаваемый объём и признак «успевает».
- Схема БД не менялась, миграции нет.
